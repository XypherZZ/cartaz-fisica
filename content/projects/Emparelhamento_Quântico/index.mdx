...
Durante a passagem pelo ensino secundário estudámos vários tipos de interações entre as partículas: Força gravítica, Força eletromagnética, Força nuclear forte e Força nuclear fraca.
